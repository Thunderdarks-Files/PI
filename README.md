...
**Date:** 15.10.2025 Version nr 3

**Notes created by:** Thunderdarks

**Thanks to:**

**Sources:** Eve Uni, Korai Iarok for his Material Diagrams.

**Scope:** Share PI templates with other with minimal explanations. This is not a beginnerâ€™s guide.
...
AI-generated content may be incorrect.](./images/image1.png)Extract it all:

1.  On your PC, Navigate to /users/<user>/Documents/Eve/PlanetaryInteractionTemplates
2.  Unzip and paste all json files in the folder above.
3.  Refresh your templates menu in game.
4.  P0->P2 colonies must be set up on correct planet. Check the PDF file for what planet needed to have both P0 resources.
...
AI-generated content may be incorrect.](./images/image2.png) ![A screenshot of a video game
...
AI-generated content may be incorrect.](./images/image4.png) ![A screenshot of a video game
AI-generated content may be incorrect.](./images/image5.png)
...
![A screenshot of a computer
AI-generated content may be incorrect.](./images/image6.png) ![A screenshot of a computer
AI-generated content may be incorrect.](./images/image7.png)
